      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div
              data-aos="fade-down"
              className="inline-flex items-center px-3 py-1 mb-4 bg-white/30 backdrop-blur-sm rounded-full border border-white/20 shadow-sm"
            >
            ...
            <h1
              data-aos="fade-up"
              className="text-3xl md:text-5xl lg:text-6xl font-extrabold mb-4 bg-gradient-to-r from-purple-600 to-orange-500 bg-clip-text text-transparent leading-tight"
            >
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-lg md:text-xl text-gray-700 mb-6 max-w-2xl mx-auto lg:mx-0 leading-relaxed"
            >
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="600"
              className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-4 px-2"
            >
              <button
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="800"
              className="flex justify-center lg:justify-start items-center text-sm text-gray-600 gap-2 mb-6"
            >
          ...
          {/* Example Image */}
          {/* <div data-aos="fade-left" data-aos-delay="500" className="flex-1">
            <img
              src="/hero-image.png"
