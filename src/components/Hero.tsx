...
import { Flame, ArrowRight, Bot, PenTool, Sparkles } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center justify-center lg:justify-start px-3 py-1 mb-4 md:mb-6 bg-white bg-opacity-30 backdrop-blur-sm rounded-full border border-white border-opacity-20 shadow-sm">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 bg-gradient-to-r from-warmchats-primary to-warmchats-flame bg-clip-text text-transparent leading-tight">
              Turn Cold Outreach into Warm Conversations.
            </h1>
            
            <p className="text-lg md:text-xl text-gray-700 mb-6 md:mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Our AI-powered platform helps you send hyper-personalized outreach messages in seconds across multiple channels, increasing your response rates by 300%.
            </p>
            
            <div className="mb-6 md:mb-8 flex justify-center lg:justify-start">
              <WaitlistForm location="hero" showFlame={true} />
            </div>
            
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 md:gap-6 items-center">
              <div className="flex items-center gap-2 bg-white bg-opacity-50 backdrop-blur-sm rounded-full px-3 md:px-4 py-1.5 shadow-sm">
