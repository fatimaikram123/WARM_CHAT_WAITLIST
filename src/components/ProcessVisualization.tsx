...
import { Mail, MessageSquare, Sparkle, Play, ArrowRight, Bot, Flame } from 'lucide-react';
    ...
    <section id="process" className="section-padding bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p className="section-subtitle mb-12 md:mb-16">
          Turn your outreach into real conversations in just three simple steps
        </p>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 lg:gap-12 relative">
          ...
          <div className="flex-1 w-full max-w-sm lg:max-w-none bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 relative z-10 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div className="absolute -top-3 md:-top-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-warmchats-primary to-warmchats-primary-dark text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold shadow-md text-sm md:text-base">
              1
            </div>
            <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 mt-3 md:mt-4 text-center">
              Select a Platform
            </h3>
            <div className="bg-warmchats-primary-light p-3 md:p-5 rounded-lg mb-3 md:mb-4">
              <div className="flex justify-center gap-3 md:gap-4">
                <div className="bg-white p-2 md:p-3 rounded-lg shadow-sm hover:shadow-md transition-all transform hover:scale-105 cursor-pointer">
                  <MessageSquare size={24} className="text-warmchats-primary md:w-7 md:h-7" />
                </div>
                <div className="bg-white p-2 md:p-3 rounded-lg shadow-sm hover:shadow-md transition-all transform hover:scale-105 cursor-pointer">
            ...
            <p className="text-gray-600 text-xs md:text-sm text-center">
              Choose to send your message through SMS or Email
            </p>
          </div>
          ...
          <div className="flex-1 w-full max-w-sm lg:max-w-none bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 relative z-10 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div className="absolute -top-3 md:-top-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-warmchats-primary to-warmchats-flame text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold shadow-md text-sm md:text-base">
              2
            </div>
            <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 mt-3 md:mt-4 text-center">
              Write a Prompt
              ...
              <div className="bg-white border border-gray-200 p-3 md:p-4 rounded-lg shadow-inner">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-xs md:text-sm text-gray-700 font-medium">
                    Write to Sarah about our new product launch...
                  </p>
                </div>
            ...
            <p className="text-gray-600 text-xs md:text-sm text-center">
              Tell WarmChat what you want to say and who you’re reaching out to
            </p>
          </div>
          ...
          <div className="flex-1 w-full max-w-sm lg:max-w-none bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 relative z-10 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div className="absolute -top-3 md:-top-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-warmchats-flame to-warmchats-primary text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold shadow-md text-sm md:text-base">
              3
            </div>
            <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 mt-3 md:mt-4 text-center">
              Generated Message
            ...
            <div className="bg-warmchats-primary-light p-3 md:p-5 rounded-lg mb-3 md:mb-4 relative">
              <div className="bg-white border border-warmchats-primary border-opacity-20 p-3 md:p-4 rounded-lg shadow-inner">
                ...
                <p className="text-xs md:text-sm">
                  Hi Sarah, I saw your recent post about automation — our tool can help streamline your workflow...
                </p>
                <div className="flex justify-end mt-1.5 md:mt-2">
            ...
            <p className="text-gray-600 text-xs md:text-sm text-center">
              Get a ready-to-send, personalized message in seconds
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-12 md:mt-16">
          <a
            ...
            className="inline-flex items-center gap-2 bg-white border border-warmchats-primary text-warmchats-primary px-4 md:px-6 py-2 md:py-3 rounded-full hover:bg-warmchats-primary hover:text-white transition-colors shadow-sm text-sm md:text-base"
          >
