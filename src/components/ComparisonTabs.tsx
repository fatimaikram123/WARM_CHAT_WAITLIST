  ...
  const comparisonFeatures = [
    {
      ...
      warmchatsIcon: <CheckCircle className="text-green-600 w-5 h-5 inline-block mr-1" />,
    ...
    },
    {
      ...
      warmchatsIcon: <CheckCircle className="text-green-600 w-5 h-5 inline-block mr-1" />,
      mailchimpIcon: <CheckCircle className="text-green-600 w-5 h-5 inline-block mr-1" />
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-16 space-y-6">
          {comparisonFeatures.map((feature, idx) => (
            <div key={idx} className="bg-white rounded-2xl shadow-md p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 hover:shadow-lg transition">
        ...
        <div className="space-y-6">
          {pricingPlans.map((plan, idx) => (
            <div key={idx} className="bg-white rounded-2xl shadow-md p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 hover:shadow-lg transition">
              ...
              <div className="md:w-1/2 bg-green-50 p-4 rounded-xl flex items-start gap-2">
                <CheckCircle className="text-green-600 w-5 h-5 inline-block mr-1" />
