...
const OrganizationList: React.FC = () => {
  ...
  return (
    <MainLayout>
      <div className="p-4 sm:p-6 min-h-screen bg-gradient-to-br">
        <div className="max-w-3xl mx-auto bg-white shadow-md rounded-xl p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 mb-4">
            <input
              ...
              className="border border-gray-300 rounded px-3 py-2 flex-1 text-sm sm:text-base"
            />
            <button
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[600px] w-full border border-gray-200 rounded-lg">
                ...
                <tbody>
                  {orgs.map((org) => (
                    <tr key={org.id} className="border-t text-sm">
                      <td className="p-3">
                        <input
                          type="text"
                          defaultValue={org.name}
                          onBlur={(e) =>
                            handleUpdateOrg(org.id, e.target.value)
                          }
                      ...
                      <td className="p-3">
                        <button
                          onClick={() =>
                            handleUpdateOrg(org.id, org.name)
                          }
